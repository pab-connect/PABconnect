...
export default function CadastroConcluido() {
  return (
    <div className="bg-[#307039] h-screen w-screen flex items-center justify-center">
        <section className="w-4/5 h-2/4 bg-white flex flex-col justify-center items-center p-10 text-center">
        ...
        <p className="text-lg text-gray-700 mb-8">
            Agora você faz parte da nossa rede de jogadoras em busca de oportunidades!
        </p>
