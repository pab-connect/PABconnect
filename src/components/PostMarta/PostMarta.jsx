...
import martaPerfil from "../../assets/imagem-marta.jpg"
import martaPost from "../../assets/post-marta.jpg"

export default function PostMarta() {
    return (
        <div className="bg-white p-4 w-full rounded-xl mt-2 border border-[#85a095]">
            <div className='flex items-center justify-between'>
                <div className='flex gap-4 items-center'>
                    <img src={martaPerfil} alt="icon marta" className="w-11 h-11 md:w-13 md:h-13 lg:w-16 lg:h-16 rounded-full border-2 border-[#9f92bc] ml-3 cursor-pointer"/>
            ...
            <div className='m-4'>
                <img src={martaPost} alt="post marta" className='rounded-3xl'/>
            </div>
