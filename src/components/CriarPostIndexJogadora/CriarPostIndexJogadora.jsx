        ...
        <div className='flex flex-col bg-white p-4 w-full rounded-xl border border-[#85a095]'>
            ...
            <div className='flex items-center justify-between'>
                <div className="flex items-center text-[#307039]">
                    <button className='flex-1 p-4 items-center justify-center cursor-pointer hover:scale-110 duration-300 transition-all'><Camera className='w-6 h-6 md:w-7 md:h-7 lg:w-9 lg:h-9'/></button>
                ...
                <div className="flex items-center text-[#307039]">
                    ...
                    <button className='flex-1 p-3 items-center justify-center cursor-pointer hover:scale-110 duration-300 transition-all'><SquarePen className='w-6 h-6 md:w-7 md:h-7 lg:w-9 lg:h-9'/></button>
                </div>
            </div>
        </div>
    )
